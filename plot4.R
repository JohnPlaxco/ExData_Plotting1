...
plot(goodtimeanddate, dataofinterest$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
...
plot(goodtimeanddate, dataofinterest$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
